...
const (
	Auth_Create_FullMethodName = "/user_v1.Auth/Create"
	Auth_Get_FullMethodName    = "/user_v1.Auth/Get"
	Auth_Update_FullMethodName = "/user_v1.Auth/Update"
	Auth_Delete_FullMethodName = "/user_v1.Auth/Delete"
)
...
func (c *authClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateRespone, error) {
...
func (UnimplementedAuthServer) Create(context.Context, *CreateRequest) (*CreateRespone, error) {
