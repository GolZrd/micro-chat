...
- **Prometheus** - Прометеус метрики в каждом сервисе

## 📝 Roadmap
- [x] Настроить отображение количества чатов на главной странице
- [x] Добавить проверку существования пользователя при создании чата
...
- [x] Исправить в таблице users название колонки "name" на "username"
- [ ] Добавить circuit breaker
- [ ] Добавить таймауты 
- [x] Добавить отображение онлайна в чате
- [ ] Добавить возможность записывать голосовые сообщения
